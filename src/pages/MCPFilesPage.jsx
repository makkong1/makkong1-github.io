function MCPFilesPage() {
  const docsStructure = [
    {
      ...
      files: [
        ...
        {
          name: "위치서비스 공공데이터 CSV 배치 임포트",
          file: "위치서비스_공공데이터_CSV_배치_임포트_구현.md",
        },
        {
          name: "관리자 통계 시스템 전략",
          file: "# 관리자 통계 시스템 전략.md",
        },
        { name: "알림 시스템 전략 정리", file: "# 알림 시스템 전략 정리.md" },
        {
          name: "유저 제한 및 제재 시스템",
          file: "# 유저 제한 및 제재 시스템.md",
        },
      ],
    },
    {
    ...
    },
    {
      category: "성능 최적화",
      path: "performance",
      files: [{ name: "쿼리 최적화", file: "query-optimization.md" }],
    },
    {
      category: "동시성 제어",
      path: "concurrency",
      files: [
        ...
        {
          name: "트랜잭션 동시성 케이스",
          file: "transaction-concurrency-cases.md",
        },
      ],
    },
    {
      ...
      files: [
        ...
        {
          name: "사용자 소프트 삭제 및 관리자 패널 개선",
          file: "# 사용자 소프트 삭제 및 관리자 패널 개선.md",
        },
        {
          name: "서버 사이드 페이징 구현 가이드",
          file: "# 서버 사이드 페이징 구현 가이드.md",
        },
        {
          name: "성능 테스트 및 문제 상황 재현 TODO",
          file: "# 성능 테스트 및 문제 상황 재현 TODO.md",
        },
        {
          name: "실시간 알림 시스템 구현 문서",
          file: "# 실시간 알림 시스템 구현 문서.md",
        },
        {
          name: "통계 집계 로직 구현 명세",
          file: "# 통계 집계 로직 구현 명세.md",
        },
        {
          name: "프론트엔드 게시글 데이터 구조 최적화",
          file: "# 프론트엔드 게시글 데이터 구조 최적화.md",
        },
        {
          name: "게시글 카운트 실시간 업데이트 구현",
          file: "게시글 카운트 실시간 업데이트 구현.md",
        },
        {
          name: "밴된 사용자 콘텐츠 필터링 구현",
          file: "밴된 사용자 콘텐츠 필터링 구현.md",
        },
    ...
    },
    {
      ...
      files: [
        ...
        {
          name: "GitHub Pages 구현 가이드",
          file: "GitHub_Pages_구현_가이드.md",
        },
        {
          name: "GitHub Pages 다음 단계 가이드",
          file: "GitHub_Pages_다음_단계_가이드.md",
        },
        {
          name: "GitHub Pages 포트폴리오 구현 계획",
          file: "GitHub_Pages_포트폴리오_구현_계획.md",
        },
      ],
    },
  ];
  ...
  const getFileUrl = (categoryPath, fileName) => {
    const baseUrl =
      "https://github.com/makkong1/makkong1-github.io/blob/main/docs";
    if (categoryPath) {
