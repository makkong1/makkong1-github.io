    ...
    points: [
      {
        label: '문제',
        text:
          '직접 작성한 SQL과 애플리케이션이 실제로 실행하는 쿼리가 달랐습니다. Page<>는 목록 SELECT와 COUNT를 각각 실행하는데, 그중 하나만 보고 튜닝을 끝냈습니다.',
      },
      {
        label: '원인',
        text:
          'API를 호출하지 않고 측정했습니다. 직접 쓴 SQL로는 Hibernate가 생성하는 쿼리, Page<>에 딸려 나가는 COUNT, 지연 로딩으로 추가되는 쿼리를 볼 수 없습니다.',
      },
      {
        label: '해결',
        text:
