          ...
          <section id="why" style={{ marginBottom: '3rem', scrollMarginTop: '2rem' }}>
            ...
            <div className="section-card">
              <div className="about-text-block">
                <p>
                  문제를 재현하고 측정하며 개선하는 백엔드 개발자입니다.
                </p>
                <p>
                  Spring Boot, JPA, MySQL 기반 프로젝트를 진행하며 기능 구현에 그치지 않고,
                  각 도메인에서 발생할 수 있는 N+1 문제와 동시성 이슈를 직접 재현하고
                  쿼리 수·응답 시간·메모리 사용량으로 개선 결과를 확인해 왔습니다.
                </p>
                <p>
                  위치 기반 검색에서는 공간 쿼리와 거리 계산을 활용했고,
                  동시성 제어에서는 비관적 락과 원자적 UPDATE 방식을 비교하며
                  상황에 맞는 적용 기준을 정리했습니다.
                </p>
                <p>
                  새로운 분야를 배울 때의 시행착오는 당연하다고 봅니다. 어려운 상황에서도 결과를
                  회피하거나 책임을 다른 데 두기보다, 내 판단과 실행을 차분히 검토하고 다음에 반영하려
                  합니다.
                </p>
              </div>
            </div>
