              ...
              marginTop: '1rem'
                ...
                <div style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
                  <p style={{ marginBottom: '0.75rem' }}>
                    단건 상세 → Fetch Join / 페이징 목록 → Batch Size 규칙에 따라 Location 도메인(LocationServiceReview) Fetch 전략을 개선했습니다.
                  </p>
                  <div style={{
                    padding: '1rem',
                    backgroundColor: 'var(--bg-color)',
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                      ...
                      <tbody>
                        <tr style={{ borderBottom: '1px solid var(--nav-border)' }}>
                          <td style={{ padding: '0.75rem' }}>LocationService</td>
                          <td style={{ padding: '0.75rem' }}>목록 조회</td>
                          <td style={{ padding: '0.75rem' }}>N/A</td>
                          <td style={{ padding: '0.75rem' }}>✅ reviews 미접근</td>
                        </tr>
                        <tr>
                          <td style={{ padding: '0.75rem' }}>LocationServiceReview</td>
                          <td style={{ padding: '0.75rem' }}>서비스별/사용자별 목록, 단건 수정·삭제</td>
                  ...
                  <div style={{
                    ...
                    <a
                      href="https://github.com/makkong1/makkong1-github.io/blob/main/docs/refactoring/fetch-optimization/location/Fetch%20%EC%A0%84%EB%9E%B5%20%EA%B0%9C%EC%84%A0%20(Fetch%20Join%20vs%20Batch%20Size).md"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        color: 'var(--link-color)',
